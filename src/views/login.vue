<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      <h3 class="title">联通移网投诉后台管理系统</h3>
      ...
      <el-form-item style="width:100%;" v-if="!isSmsLogin">
        <el-button
          :loading="loading"
          size="medium"
          type="primary"
      ...
      <el-form-item style="width:100%;" v-if="isSmsLogin">
        ...
        <div style="text-align: center">
          <span>未注册过的手机号会自动创建账号</span>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
    <div class="el-login-footer">
      <span>Copyright © 2024 yangsen All Rights Reserved.</span>
    </div>
  </div>
</template>
          ...
          if(this.isSmsLogin){
            ...
            this.$store.dispatch("SmsLogin", this.loginForm).then(() => {
              if (this.$store.state.user.isRegister) {
                this.$router.push({ path: "/profile/registerTwo" });
              } else {
