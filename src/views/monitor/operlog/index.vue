  ...
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="操作类型" align="center" prop="businessType">
        <template slot-scope="scope">
          <template v-for="businessType in businessTypeOptions" v-if="businessType.value === scope.row.businessType">
            {{businessType.label}}
          </template>
        </template>
      </el-table-column>
    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="12">
            <el-form-item label="操作模块：">{{ form.title }} /
              <template v-for="businessType in businessTypeOptions" v-if="businessType.value === form.businessType">
                {{businessType.label}}
              </template>
            </el-form-item>
            <el-form-item
