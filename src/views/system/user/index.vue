        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属网格" prop="grid">
              <el-select v-model="form.grid" placeholder="请选择所属网格">
                <el-option v-for="grid in gridOption"
                           :key="grid.value"
                           :label="grid.label"
                           :value="grid.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.grid === '3'">
            <el-form-item label="其他网格" prop="otherGrid">
              <el-input v-model="form.otherGrid" placeholder="请输入其他网格" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
